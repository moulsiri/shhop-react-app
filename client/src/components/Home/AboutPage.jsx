...
<i className="ri-mail-line"></i>
  <a target='blank' href="https://mail.google.com/mail/u/0/?fs=1&to=maulsiri2301@gmail.com&tf=cm">gmail</a>
  </div>
  <div className="linkElm">
  <i className="ri-github-fill"></i>
  <a target='blank'  href="https://github.com/moulsiri">gitHub</a>
  </div>
  <div className="linkElm">
  <i className="ri-linkedin-fill"></i>
  <a target='blank'  href="https://www.linkedin.com/in/moulsiri-awasthi-8395261a6">linkedin </a>
  </div>
  <div className="linkElm">
  <i className="ri-terminal-box-fill"></i>
  <a target='blank'  href="https://leetcode.com/moulsiri/">leetcode</a>
  </div>
  <div className="linkElm">
  <i className="ri-instagram-line"></i>
  <a target='blank'  href="https://www.instagram.com/moul.siri/">instagram</a>
  </div>
</div>
      </div>
      <div id="art">
